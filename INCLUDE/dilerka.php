...
<body>
	<div class=container>
        ...
        if(isset($_SESSION['dilerkastop']) && $_SESSION['dilerkastop']){
            echo "<p id=losewalka>Jak będziesz za często dilował to zgarniesz przypał. Poczekaj trochę</p>";
            ...
            if(isset($_POST['dil'])){
                switch($_POST['dil']){
                    ...
                    if($szansa<15){
                        ...
                        $czas=10;
                        echo "<p id=winwalka>Udało Ci się bez przypału. Zgarnąłeś $hajs PLN i $progress szacunku</p>";
                        $_SESSION['hajs']+=$hajs;

...
<body>
	...
	<div class=container>
        ...
        if(isset($_SESSION['przestepstwastop']) && $_SESSION['przestepstwastop']){
            echo "<p id=losewalka>Spokojnie, nie szalej tak - odpocznij trochę od przestępstw</p>";
            ...
            if(isset($_POST['crime'])){
                ...
                case 1:
                    ...
                    function wygrana(){
                        ...
                        $id = $_SESSION['id'];
                        $unconnect=connect();
                        echo "<p id=winwalka>Udało Ci się, zyskałeś $hajs PLN i $progress do szacunku</p>";
                    ...
                    function przegrana(){
                        ...
                        echo "<p id=losewalka>Trafiasz do więzienia na ".$czas." minuty!</p>";
                    }
                ...
                function przegrana(){
                    ...
                    $_SESSION['wiezieniestop1']=true;
                    echo "<p id=losewalka>Trafiasz do więzienia na ".$czas." minut!</p>";
                }
                    if($_SESSION['progress']<50){
                        if($szansa<=0){
                           wygrana();

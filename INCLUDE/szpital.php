...
<body>
	...
	<div class=container>
        ...
        <form method="POST">
                ...
                <td><input type=number min=1 max=<?=$max?> value=<?=$max?> name=szpital id=szpital /></td>
                <td><input type=submit value="Idź do szpitala" id=szpitalsubmit></td>
            
        </form>

        <?php
		if(isset($_SESSION['szpitalstop']) && $_SESSION['szpitalstop']){
			echo "<p id=losewalka>Byłeś miękką fają, teraz musisz odsiedzieć swoje. Posiedzisz tu trochę.</p>";

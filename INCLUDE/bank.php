...
<body>
	<div class=container>
		...
		<div id=content>
            ...
            <form method="POST">    
                <td><input type=number style="color: black"  class=bank  min=0 max=<?=$max?> value=<?=$max?> name=wplac /></td>
                <td><input type=submit class=banksubmit value="Wpłać hajs do banku"></td>     
            </form>
            <form method="POST">    
                <td><input type=number style="color: black"  class=bank  min=0 max=<?=$max2?> value=<?=$max2?> name=wyplac /></td>
                <td><input type=submit class=banksubmit value="Wypłać pieniądze"></td>     
            </form>
            <br /><br />

...
<body>
	...
	<div class=container>
		...
		if($_SESSION['zdrowie']<25)
			echo "<p id=losewalka>Masz za mało zdrowia żeby walczyć. Musisz
		...
		<form action="walka.php" method="POST">
			<div id=walka>
				...
				<input type=submit value="Walcz!" class=button>
			</div>
		</form>';
		}
		?>
						...
						{		
							...
							{	
								...
								if($bz<=0){
									...
									echo "<p id=winwalka>Wygrałeś! Zyskałeś $progress doświadczenia oraz $hajs hajsu.</p>";
									break;
								}	
								elseif($az<=0){
									...
									echo "<p id=losewalka>Ale lipa - emeryt dał Ci nieźle popalić</p>";
									break;
								}
								else echo "";
							}
							...
							{	
								...
								if($az<=0){
									...
									echo "<p id=losewalka>Przegrałeś z emerytem, lepiej się tu więcej nie pokazuj</p>";
									break;
								}	
								elseif($bz<=0){
									$_SESSION['progress']+=$progress;
						...
						{		
							...
							{	
								...
								elseif($az<=0){
									...
									echo "<p id=losewalka>To nie Twoje osiedle, Sebix Cię dojechał</p>";
									break;
								}
								else echo "";
							}
							...
							{	
								...
								if($az<=0){
									...
									echo "<p id=losewalka>Przegrałeś z Sebixem miękka fajo</p>";
									break;
								}	
								elseif($bz<=0){
									$_SESSION['progress']+=$progress;
